...
int main( int argc, char** argv )
{
  ...
  reaction_kinematics * kZc = new reaction_kinematics(mZc*mZc);
  ...
  // Zb(10610)
  double mZb = 10.6072;
  reaction_kinematics * kZb = new reaction_kinematics(mZb*mZb);
  ...
  // Zb(10650)
  double mZbp = 10.6522;
  reaction_kinematics * kZbp = new reaction_kinematics(mZbp*mZbp);
